...
// EnterOptListBlock is called when production optListBlock is entered.
func (s *Basedae_configListener) EnterOptListBlock(ctx *OptListBlockContext) {}

// ExitOptListBlock is called when production optListBlock is exited.
func (s *Basedae_configListener) ExitOptListBlock(ctx *OptListBlockContext) {}
...
// EnterRoutingRuleLeft is called when production routingRuleLeft is entered.
func (s *Basedae_configListener) EnterRoutingRuleLeft(ctx *RoutingRuleLeftContext) {}

// ExitRoutingRuleLeft is called when production routingRuleLeft is exited.
func (s *Basedae_configListener) ExitRoutingRuleLeft(ctx *RoutingRuleLeftContext) {}

// EnterOptFunctionPrototypeExpressionAnd is called when production optFunctionPrototypeExpressionAnd is entered.
func (s *Basedae_configListener) EnterOptFunctionPrototypeExpressionAnd(ctx *OptFunctionPrototypeExpressionAndContext) {
}

// ExitOptFunctionPrototypeExpressionAnd is called when production optFunctionPrototypeExpressionAnd is exited.
func (s *Basedae_configListener) ExitOptFunctionPrototypeExpressionAnd(ctx *OptFunctionPrototypeExpressionAndContext) {
}
