...
public:
  ...
  explicit dae_configLexer(antlr4::CharStream *input);

  ~dae_configLexer() override;
...
private:
  ...
  bool COMMENT_LINE_SHARPSempred(antlr4::RuleContext *_localctx, size_t predicateIndex);
