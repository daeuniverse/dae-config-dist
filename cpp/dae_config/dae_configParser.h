...
public:
  ...
  enum {
    ...
    RuleInput = 4, RuleProgramStructureBlcok = 5, RuleExpression = 6, RuleDeclaration = 7, 
    RuleFunctionPrototype = 8, RuleOptParameterList = 9, RuleNonEmptyParameterList = 10, 
    RuleParameter = 11, RuleRoutingRule = 12, RuleRoutingRuleLeft = 13, 
    RuleOptFunctionPrototypeExpressionAnd = 14, RuleFunctionPrototypeExpression = 15, 
    RuleRoutingRuleOrDeclarationOrLiteralOrExpressionList = 16, RuleRoutingRuleList = 17
  };
