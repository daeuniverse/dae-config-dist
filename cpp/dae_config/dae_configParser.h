...
public:
  ...
  enum {
    ...
    RuleExpression = 7, RuleDeclaration = 8, RuleFunctionPrototype = 9, 
    RuleOptParameterList = 10, RuleNonEmptyParameterList = 11, RuleParameter = 12, 
    RuleRoutingRule = 13, RuleOutboundExpr = 14, RuleFunctionPrototypeExpression = 15, 
