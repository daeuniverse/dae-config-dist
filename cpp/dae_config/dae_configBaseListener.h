...
public:
  ...
  virtual void enterOptListBlock(dae_configParser::OptListBlockContext * /*ctx*/) override { }
  virtual void exitOptListBlock(dae_configParser::OptListBlockContext * /*ctx*/) override { }
